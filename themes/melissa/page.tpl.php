...
<a href="#content" style="display: none">skip to content</a>
  ...
  <div id="main" class="grid-12 clearfix">
    <div id="nav" class="grid-2 alpha">
      ...
      <h1 id="site-name"><img src="/<?php print $directory; ?>/site-name.jpg" alt="At Home" /></h1></a>
      <?php print render($page['nav_left']); ?>
    </div>
    <div id="feature" class="grid-4">
      <div class="decoration"><img src="/<?php print $directory; ?>/feature-decoration-top.jpg" alt="Furniture, Linen, Dishes" /></div>
      <?php print render($page['feature_middle']); ?>
      <div class="decoration"><img src="/<?php print $directory; ?>/feature-decoration-bottom.jpg" alt=" " /></div>
    </div>
  ...
  <div id="copyright" class="grid-12 clearfix"><?php print render($page['copyright_footer']); ?></div>
</div>
